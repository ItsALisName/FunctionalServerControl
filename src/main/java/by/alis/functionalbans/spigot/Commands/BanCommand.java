            ...
            if(args.length >= 1) {
                                ...
                                if (!target.hasPermission("functionalbans.ban.bypass")) {
                                    ...
                                    if(!sender.hasPermission("functionalbans.time-bypass")) {
                                        Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                            banManager.preformBan(((OfflinePlayer) target), BanType.TIMED_NOT_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), false);
                                        });
                                    } else {
                                        Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                        ...
                        if (getConfigSettings().isUnsafeActionsConfirmation()) {
                            ...
                            for (Player target : Bukkit.getOnlinePlayers()) {
                                ...
                                if (!target.hasPermission("functionalbans.ban.bypass")) {
                                    ...
                                    if(!sender.hasPermission("functionalbans.time-bypass")) {
                                        Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                            banManager.preformBan(((OfflinePlayer) target), BanType.TIMED_NOT_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), true);
                                        });
                                    } else {
                                        Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                ...
                if (args.length == 1) {
                    ...
                    if(!OtherUtils.isNotNullPlayer(player.getUniqueId())) {
                        ...
                        if(!sender.hasPermission("functionalbans.time-bypass")) {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                banManager.preformBan(args[0], BanType.TIMED_NOT_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), true);
                            });
                        } else {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                        ...
                        if(!sender.hasPermission("functionalbans.time-bypass")) {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                banManager.preformBan(player, BanType.TIMED_NOT_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), true);
                            });
                        } else {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                ...
                if(args.length >= 2) {
                    if(args[0].equalsIgnoreCase("-s") && args.length == 2) {
                        ...
                        if(!OtherUtils.isNotNullPlayer(player.getUniqueId())) {
                            ...
                            if(!sender.hasPermission("functionalbans.time-bypass")) {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                    banManager.preformBan(args[1], BanType.TIMED_NOT_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), false);
                                });
                            } else {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                            ...
                            if(!sender.hasPermission("functionalbans.time-bypass")) {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                    banManager.preformBan(player, BanType.TIMED_NOT_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), false);
                                });
                            } else {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                    ...
                    if(args.length > 2 && args[0].equalsIgnoreCase("-s") && !timeSettingsAccessor.getTimeChecker().checkInputTimeArgument(args[2])) {
                        ...
                        if(!OtherUtils.isNotNullPlayer(player.getUniqueId())) {
                            ...
                            if(!sender.hasPermission("functionalbans.time-bypass")) {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                    banManager.preformBan(args[1], BanType.TIMED_NOT_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), false);
                                });
                            } else {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                            ...
                            if(!sender.hasPermission("functionalbans.time-bypass")) {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                    banManager.preformBan(player, BanType.TIMED_NOT_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), false);
                                });
                            } else {
                                Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                    ...
                    if(!OtherUtils.isNotNullPlayer(player.getUniqueId())) {
                        ...
                        if(!sender.hasPermission("functionalbans.time-bypass")) {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                banManager.preformBan(args[0], BanType.TIMED_NOT_IP, getReason(args, 1), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), true);
                            });
                        } else {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                        ...
                        if(!sender.hasPermission("functionalbans.time-bypass")) {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
                                banManager.preformBan(player, BanType.TIMED_NOT_IP, getReason(args, 1), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerPunishTime((Player)sender), true);
                            });
                        } else {
                            Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
