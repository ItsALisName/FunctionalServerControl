...
public class GeneralConfigSettings {
    ...
    public void setUnsafeActionsConfirmation(boolean unsafeActionsConfirmation) {
    ...
    private void setApiProtectedByPassword(boolean apiProtectedByPassword) {
        this.isApiProtectedByPassword = apiProtectedByPassword;
    }
    ...
    private void setAllowedUseRamAsContainer(boolean allowedUseRamAsContainer) {
        this.isAllowedUseRamAsContainer = allowedUseRamAsContainer;
    }
    ...
    public void setHideMainCommand(boolean hideMainCommand) {
    ...
    public void loadConfigSettings() {
        ...
        if(getConsoleLanguageMode().equalsIgnoreCase("ru_RU")) {
        ...
        } else if(getConsoleLanguageMode().equalsIgnoreCase("en_US")) {
