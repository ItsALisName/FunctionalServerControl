...
public class TempBanIpCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args) {
            ...
            if (args.length == 2 && args[0].equalsIgnoreCase("-s")) {
                ...
                if (sender.hasPermission("functionalservercontrol.tempban-ip") && sender.hasPermission("functionalservercontrol.use.silently")) {
