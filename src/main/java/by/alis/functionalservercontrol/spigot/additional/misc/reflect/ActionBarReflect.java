        ...
        TaskManager.preformAsync(() -> {
            try {
                ...
                if (serverVersion.equalsIgnoreCase("v1_12_R1") ||
                    ...
                    playerConnection.getClass().getMethod("sendPacket", MinecraftReflection.getNMSClass("Packet")).invoke(playerConnection, packetPlayOutChat);
                    ...
                    Object playerHandle = player.getClass().getMethod("getHandle").invoke(player);
                    Object playerConnection = playerHandle.getClass().getField("playerConnection").get(playerHandle);
                    playerConnection.getClass().getMethod("sendPacket", MinecraftReflection.getNMSClass("Packet")).invoke(playerConnection, packetPlayerOutChat);
                } else {
