...
public class MuteEntry implements FunctionalMuteEntry{
    ...
    public MuteEntry(@Nullable String name, @NotNull String id, @Nullable String address, @NotNull String initiator, @NotNull String reason, @NotNull MuteType muteType, @NotNull String muteDate, @NotNull String muteTime, @Nullable UUID uuid, long unmuteTime) {
        this.name = name;
        this.id = id;
