...
import by.alis.functionalservercontrol.spigot.Additional.Libraries.org.apache.commons.lang3.builder.EqualsBuilder;
import by.alis.functionalservercontrol.spigot.Additional.Libraries.org.apache.commons.lang3.builder.HashCodeBuilder;
import by.alis.functionalservercontrol.spigot.Additional.Libraries.org.apache.commons.lang3.builder.ToStringBuilder;
import by.alis.functionalservercontrol.spigot.Additional.Libraries.org.apache.commons.lang3.builder.ToStringStyle;
...
public class ArrayUtils {
    ...
    public static Object[] add(Object[] array, Object element) {
        Class type;
        if (array != null) {
            type = (Class)array.getClass();
        } else if (element != null) {
            type = (Class)element.getClass();
        } else {
            type = Object.class;
        }
    ...
    public static boolean[] add(boolean[] array, int index, boolean element) {
        return (boolean[])add(array, index, BooleanUtils.toBooleanObject(element), boolean.class);
    }

    public static char[] add(char[] array, int index, char element) {
        return (char[])add(array, index, new Character(element), char.class);
    }

    public static byte[] add(byte[] array, int index, byte element) {
        return (byte[])add(array, index, new Byte(element), byte.class);
    }

    public static short[] add(short[] array, int index, short element) {
        return (short[])add(array, index, new Short(element), short.class);
    }

    public static int[] add(int[] array, int index, int element) {
        return (int[])add(array, index, new Integer(element), int.class);
    }

    public static long[] add(long[] array, int index, long element) {
        return (long[])add(array, index, new Long(element), long.class);
    }

    public static float[] add(float[] array, int index, float element) {
        return (float[])add(array, index, new Float(element), float.class);
    }

    public static double[] add(double[] array, int index, double element) {
        return (double[])add(array, index, new Double(element), double.class);
    }
