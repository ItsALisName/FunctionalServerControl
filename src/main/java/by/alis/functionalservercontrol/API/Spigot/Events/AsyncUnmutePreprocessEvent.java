...
public class AsyncUnmutePreprocessEvent extends Event implements Cancellable {
    ...
    public AsyncUnmutePreprocessEvent(OfflinePlayer player, CommandSender initiator, String reason, boolean isApiEnabled) {
        super(true);
    ...
    public AsyncUnmutePreprocessEvent(String nullPlayer, CommandSender initiator, String reason, boolean isApiEnabled) {
        super(true);
        this.isApiEnabled = isApiEnabled;
        this.initiator = initiator;
    ...
    public AsyncUnmutePreprocessEvent(OfflinePlayer player, String reason, boolean isApiEnabled) {
        super(true);
        this.reason = reason;
        this.isApiEnabled = isApiEnabled;
        this.player = player;
    ...
    public AsyncUnmutePreprocessEvent(String nullPlayer, String reason, boolean isApiEnabled) {
        super(true);
        this.nullPlayer = nullPlayer;
        this.reason = reason;
        this.isApiEnabled = isApiEnabled;
