...
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.utils.world.Dimension;
...
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.exceptions.WrapperFieldNotFoundException;
...
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.exceptions.WrapperUnsupportedUsageException;
...
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.packetwrappers.api.WrapperPacketWriter;
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.packetwrappers.api.WrapperPacketReader;
...
public class WrappedPacket implements WrapperPacketReader, WrapperPacketWriter
{
    ...
    public Object readAnyObject(final int index) {
        try {
            ...
            catch (IllegalAccessException | NullPointerException | ArrayIndexOutOfBoundsException ex2) {
