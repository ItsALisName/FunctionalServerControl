...
package net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.injector.modern.early;
        ...
        synchronized (networkManagers) {
            for (final Object networkManager : networkManagers) {
                ...
                if (channel != null) {
                    ...
                    channel.pipeline().addBefore("packet_handler", PacketEvents.get().getHandlerName(), (ChannelHandler)new PlayerChannelHandlerModern());
                }
            }
        }
    }
