...
package net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.utils.server;
...
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.utils.boundingbox.BoundingBox;
import org.spigotmc.SpigotConfig;
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.utils.nms.NMSUtils;
import org.bukkit.entity.Entity;
import java.util.Map;
import net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.utils.npc.NPCManager;
...
public final class ServerUtils
{
    ...
    public List<Entity> getEntityList(final World world) {
        ...
        if (ServerUtils.v_1_17 == 1) {
            ...
            try {
                nmsEntitiesIterable = (Iterable<Object>)ServerUtils.getLevelEntityGetterIterable.invoke(levelEntityGetter, new Object[0]);
            }
