...
package net.alis.functionalservercontrol.libraries.io.github.retrooper.packetevents.utils.nms;
...
public final class NMSUtils
{
    ...
    public static List<Object> getNetworkManagers() {
        ...
        while (true) {
            try {
                final List<?> list = serverConnectionWrapper.readObject(i, List.class);
    ...
    public static Object generatePacketDataSerializer(final Object byteBuf) {
        ...
        catch (InstantiationException | InvocationTargetException | IllegalAccessException ex2) {
