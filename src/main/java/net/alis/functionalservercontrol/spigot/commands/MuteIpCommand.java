...
public class MuteIpCommand implements CommandExecutor {
    ...
    public MuteIpCommand(FunctionalServerControlSpigot plugin) {
                ...
                if(args.length == 1) {
                        ...
                        if(OtherUtils.isNotNullIp(args[0])) {
                            if(OtherUtils.getPlayerByIP(args[0]) != null) {
                                ...
                                if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                    muteManager.preformMute(player, MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer) sender), true);
                                    return;
                                } else {
                                ...
                                if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                    muteManager.preformMuteByIp(args[0], MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true, false);
                                } else {
                            ...
                            if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                muteManager.preformMuteByIp(args[0], MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true, true);
                            } else {
                    ...
                    if(player == null) {
                        ...
                        if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                            ...
                            muteManager.preformMute(args[0], MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true);
                ...
                if(args.length >= 2) {
                    if(args[0].equalsIgnoreCase("-s") && args.length == 2) {
                        ...
                        if(OtherUtils.isArgumentIP(args[1])) {
                            ...
                            if(OtherUtils.isNotNullIp(args[1])) {
                                if(OtherUtils.getPlayerByIP(args[0]) != null) {
                                    ...
                                    if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                        muteManager.preformMute(player, MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false);
                                    } else {
                                    ...
                                    if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                        muteManager.preformMuteByIp(args[1], MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false, false);
                                    } else {
                                ...
                                if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                    muteManager.preformMuteByIp(args[1], MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false, true);
                                } else {
                        ...
                        if(player == null) {
                            ...
                            if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                ...
                                muteManager.preformMute(args[1], MuteType.TIMED_IP, getGlobalVariables().getDefaultReason(), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false);
                    ...
                    if(args.length > 2 && args[0].equalsIgnoreCase("-s") && !timeSettingsAccessor.getTimeChecker().checkInputTimeArgument(args[2])) {
                        ...
                        if(OtherUtils.isArgumentIP(args[1])) {
                            ...
                            if(OtherUtils.isNotNullIp(args[1])) {
                                if(OtherUtils.getPlayerByIP(args[0]) != null) {
                                    ...
                                    if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                        muteManager.preformMute(player, MuteType.TIMED_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false);
                                    } else {
                                    ...
                                    if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                        muteManager.preformMuteByIp(args[1], MuteType.TIMED_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false, false);
                                    } else {
                                ...
                                if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                    muteManager.preformMuteByIp(args[1], MuteType.TIMED_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false, true);
                                } else {
                        ...
                        if(player == null) {
                            ...
                            if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                ...
                                muteManager.preformMute(args[1], MuteType.TIMED_IP, getReason(args, 2), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), false);
                    ...
                    if(OtherUtils.isArgumentIP(args[0])) {
                        ...
                        if(OtherUtils.isNotNullIp(args[0])) {
                            if(OtherUtils.getPlayerByIP(args[0]) != null) {
                                ...
                                if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                    muteManager.preformMute(player, MuteType.TIMED_IP, getReason(args, 1), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true);
                                } else {
                                ...
                                if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                    muteManager.preformMuteByIp(args[0], MuteType.TIMED_IP, getReason(args, 1), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true, false);
                                } else {
                            ...
                            if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                                muteManager.preformMuteByIp(args[0], MuteType.TIMED_IP, getReason(args, 1), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true, true);
                            } else {
                    ...
                    if(player == null) {
                        ...
                        if(!sender.hasPermission("functionalservercontrol.time-bypass")) {
                            ...
                            muteManager.preformMute(args[0], MuteType.TIMED_IP, getReason(args, 1), sender, timeSettingsAccessor.getTimeManager().getMaxPlayerMutePunishTime((FunctionalPlayer)sender), true);
