...
public class SpigotAdapter extends Adapter {
    ...
    public SpigotAdapter() {
        Bukkit.getConsoleSender().sendMessage(setColors("&e[net.alis.functionalservercontrol.spigot.CoreAdapters.Adapters.SpigotAdapter] Using SpigotAdapter as core adapter"));
    }
    ...
    public String toString() {
        return "net.alis.functionalservercontrol.spigot.coreadapters.adapters.SpigotAdapter@Hash -> " + Integer.toHexString(hashCode());
    }
